...
if (isset($_POST['submit'])) {
    ...
    $nom_produit = strip_tags(trim($_POST['nom_produit']));
    $quantite = strip_tags(trim($_POST['quantite']));
    $prix_unitaire = strip_tags(trim($_POST['prix_unitaire']));
    $montant_total = strip_tags(trim($_POST['montant_total']));
    $date_achat = strip_tags(trim($_POST['date']));
    

    // Insertion des données dans la base de données
    $sql = "INSERT INTO `achet`( `nompro`, `Qte`, `prixUn`, `montantT`, `dateach`)
            VALUES ('$nom_produit', '$quantite', '$prix_unitaire', '$montant_total', '$date_achat')";
...
<!-- Divider -->
        ...
        <!-- End of Sidebar -->
                ...
                <div class="container-fluid">
                        ...
                        <h2 class="text-center border text-black"><b><u>FORMULAIRES D'AJOUT d'Achats</u></b></h2><br>
                    <div class="max-w-md mx-auto bg-white rounded-lg overflow-hidden md:max-w-lg">
                        <div class="md:flex">
                            <div class="w-full px-4 py-6 ">
                       <div class="mb-1">
                        <span class="text-sm">nom Produits</span>
                        <input  id="toil" type="text" class="form-control" name="nom_produit"  class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600">
                       </div>
                       <div class="mb-1">
                        <span class="text-sm">quantités</span>
                        <input  id="toil" type="number" class="form-control" name="quantite"  class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600">
                       </div>
                       <div class="mb-1">
