...
if(isset($_POST['submit'])) {
    ...
    $produit_fourne = mysqli_real_escape_string($conn, $_POST['produit_fourne']);
    $moyen_de_payement = mysqli_real_escape_string($conn, $_POST['moyen_de_payement']);    
    
    // Insert data into database
    $sql = "INSERT INTO fournisseurs (nom_prenom, email, numero, localisation, produit_fourne, moyen_de_payement) 
            VALUES ('$nom_prenom', '$email', '$numero', '$localisation', '$produit_fourne', '$moyen_de_payement')";
...
<!-- Divider -->
                ...
                <div class="container-fluid">
                        ...
                        <h2 class="text-center border text-black"><b><u>Ajouter un Fournisseur</u></b></h2><br>
                    <div class="max-w-md mx-auto bg-white rounded-lg overflow-hidden md:max-w-lg">
                        <div class="md:flex">
                            <div class="w-full px-4 py-6 ">
                       <div class="mb-1">
                        <span class="text-sm">Nom & Prenom</span>
                       ...
                       <div class="mb-1">
                        ...
                        <input   id="toil" type="text" class="form-control" name="email"  class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600">
                       </div>
                       <div class="mb-1">
                        <span class="text-sm">Numero</span>
                        <input   id="toil" type="text" class="form-control" name="numero"  class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600">
                       </div>
                       <div class="mb-1">
                        <span class="text-sm">localisation</span>
                        <input   id="toil" type="text" class="form-control" name="localisation"  class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600">
                       </div>
                       <div class="mb-1">
                        <span class="text-sm">Produit fournit</span>
                        <input   id="toil" type="text" class="form-control" name="produit_fourne"  class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600">
                       </div>
                       <div class="mb-1">
                        <span class="text-sm">moyen de payement</span>
                        <div class="form-check">
                  <input class="form-check-input" type="radio" value="cache" name="moyen_de_payement" id="flexRadioDefault1">
             <label class="form-check-label" for="flexRadioDefault1">
               payer Cache
             </label>
            </div>
            <div class="form-check">
            <input class="form-check-input" type="radio" value="tranche" name="moyen_de_payement" id="flexRadioDefault2" >
            ...
            payement par  Tranche 
                       ...
                       <!-- <div class="mb-1">
                        ...
                        <textarea id="descr" type="text" class="form-control" name="description" class="h-24 py-1 px-3 w-full border-2 border-blue-400 rounded focus:outline-none focus:border-blue-600 resize-none"></textarea>
                       </div> -->
