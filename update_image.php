...
if(isset($_GET['del'])){
    ...
    $del = mysqli_query($conn,"SELECT * FROM `achet`  WHERE id_ach=$sup");
  echo '<div class="alert alert-danger" role="alert">
    <strong>SUpression reussie!</strong> Veillez actualiser le site .
  </div>';
}
...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-border.php">Ajouter des <b> Achats a faire</b></a>
        </div>
    </div>
</li>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="text-center"><h2>Liste des achats effectué</b></h2></div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <td><?= $ad['id_ach']?></td>
                        ...
                        <td><?= $ad['prixUn']?></td>
                        <td><?= $monT?></td>
                        <td><?= substr($ad['dateach'],0,20)?></td>
                        <td>
                            <a href="update_image.php?del=<?= $ad['id_ach']?>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                    <?php
                    }
